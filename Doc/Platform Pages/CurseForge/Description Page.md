...
**Collapsible Game Rules** Makes the GameRules UI screens collapsible by category.. Part of the **Instant Gratification Collection** — mods that respect the player's time.
...
2. Download $KebabModId-1.0.0.jar and place it in your mods folder.
3. Launch the game.
